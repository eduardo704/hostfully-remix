...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create hostfully-remix-88ab
  fly apps create hostfully-remix-88ab-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app hostfully-remix-88ab
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app hostfully-remix-88ab-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'hostfully-remix-88ab-staging' does not match app name in config file 'hostfully-remix-88ab'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name hostfully-remix-88ab-db
  fly postgres attach --app hostfully-remix-88ab hostfully-remix-88ab-db

  fly postgres create --name hostfully-remix-88ab-staging-db
  fly postgres attach --app hostfully-remix-88ab-staging hostfully-remix-88ab-staging-db
  ```
